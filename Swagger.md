...
Так же не забудьте, если хотите открывать страницу не в браузере по умолчанию, выбрать ваш браузер в выпадающем списке справа от кнопки запуска проекта:<br>
![](/image1.png)
---
Если все ещё не видите Swagger, даже после того как разрешили открывать небезопасную страницу (по мнению браузера), то попробуйте добавить к адресу /swagger, например <br>
![](/image2.png)
Тут мы имеем адрес https://localhost:7240, если не получается зайти в интерфейс Swagger, то переходим по адресу https://localhost:7240/swagger
